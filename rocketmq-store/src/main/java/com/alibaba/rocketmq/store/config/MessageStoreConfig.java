...
public class MessageStoreConfig {
    ...
    // 最大被拉取的消息字节数，消息在内存
    @ImportantField
    private int maxTransferBytesOnMessageInMemory = 1024 * 512;
    ...
    // 最大被拉取的消息字节数，消息在磁盘
    @ImportantField
    private int maxTransferBytesOnMessageInDisk = 1024 * 128;

    // 最大被拉取的消息个数，消息在磁盘
    @ImportantField
    private int maxTransferCountOnMessageInDisk = 32;
